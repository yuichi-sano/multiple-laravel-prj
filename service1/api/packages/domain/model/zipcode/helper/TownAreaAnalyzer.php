...
class TownAreaAnalyzer
{
     ...
     * @return bool                 文字列の有無
     */
    public static function hasMain(string $townArea): bool
    {
     ...
     * @return bool                 判定結果
     */
    public static function hasMainKana($townAreaKana): bool
    {
        return (bool)preg_match(
     ...
     * @return bool             判定結果
     */
    public static function hasSub($townArea): bool
    {
        return (bool)preg_match(
     ...
     * @return bool                 判定結果
     */
    public static function hasSubKana($townAreaKana): bool
    {
        return (bool)preg_match(
     ...
     * @return bool             判定結果
     */
    public static function hasSerial($townArea): bool
    {
        return (bool)preg_match(
     ...
     * @return bool                 判定結果
     */
    public static function hasSerialBanchiGou($townArea): bool
    {
        return (bool)preg_match(
     ...
     * @return bool                  分割要否
     */
    public static function needSplitKana(string $townAreaKana): bool
    {
        return (bool)preg_match(
     ...
     * @return bool        半角数字の有無
     */
    public static function hasHalfSizeNum(string $str): bool
    {
        return (bool)preg_match(
     ...
     * @return bool                 文字列の有無
     */
    public static function hasAfterSerialTownAreaKana(string $townAreaKana): bool
    {
        return (bool)preg_match(
     ...
     * @return bool                 文字列の有無
     */
    public static function hasParent(string $townArea): bool
    {
        return (bool)preg_match(
     ...
     * @return bool                 文字列の有無
     */
    public static function hasSeparator(string $townArea): bool
    {
        return (bool)preg_match(
     ...
     * @return bool                 文字列の有無
     */
    public static function hasBullets(string $townArea): bool
    {
        return (bool)preg_match(
     ...
     * @return bool                 文字列の有無
     */
    public static function hasKeyBrackets(string $townArea): bool
    {
        return (bool)preg_match(
     ...
     * @return bool                 文字列の有無
     */
    public static function hasNotSerialEndNumber(string $townArea): bool
    {
        return (bool)preg_match(
     ...
     * @return bool                 文字列の有無
     */
    public static function hasNotNumber(string $townArea): bool
    {
        return (bool)preg_match(
