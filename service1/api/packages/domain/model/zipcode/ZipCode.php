...
class ZipCode
{
    ...
    public function __construct($jis,$zipCode5,$zipCode,$prefectureKana, $cityKana, $townAreaKana, $prefecture,$city,$townArea,$isOneTownByMultiZipCode,$isNeedSmallAreaAddress,$isChoume,$isMultiTownByOnePostCode,$updated,$updateReason)
    {
        $this->jis = $jis;
